...
The first P1-P3 implementation and seven domain extensions are in place.
The registry currently exposes `numeric`, `containers`, `signatures`, and
`unicode`, `regex`, `control`, `operators`, and `types`; `--generator=all` runs
all eight. It
